...
# 1. Load data
df=pd.read_csv('C:/Users/BHAKTI/OneDrive/Desktop/SCOE/FDSL/archive/results.csv')
data=df['Total']
...
plt.hist(data,bins=30,density=True,alpha=0.4,color='purple',label='Actual Data')
